 ...
 * @since  3.8
 */
class JupgradeproTableSite extends JTable
{
	...
	public function bind($array, $ignore = '')
	{
	  $date = JFactory::getDate();
		...
		if (isset($array['id']) && $array['id'] == 0 && empty($array['created_by']))
		{
			$array['created_by'] = JFactory::getUser()->id;
		}

		if (isset($array['id']) && $array['id'] == 0 && empty($array['modified_by']))
		{
	...
	protected function _getAssetName()
	{
		...
		return 'com_jupgradepro.site.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_jupgradepro');
