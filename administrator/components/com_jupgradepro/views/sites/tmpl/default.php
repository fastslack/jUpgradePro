...
$document->addStyleSheet(JUri::root() . 'administrator/components/com_jupgradepro/assets/css/jupgradepro.css');
$document->addStyleSheet(JUri::root() . 'media/com_jupgradepro/css/list.css');
...
<form action="<?php echo JRoute::_('index.php?option=com_jupgradepro&view=sites'); ?>" method="post"
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="productList">
				...
				<?php echo JHtml::_('searchtools.sort',  'COM_JUPGRADEPRO_SITES_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_jupgradepro&task=site.edit&id='.(int) $item->id); ?>">
