...
--
-- Table structure for table `jupgrade_default_menus`
--

DROP TABLE IF EXISTS `jupgrade_default_menus`;
CREATE TABLE IF NOT EXISTS `jupgrade_default_menus` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `jupgrade_default_menus`
--

INSERT INTO `jupgrade_default_menus` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `jupgrade_default_categories`
--

DROP TABLE IF EXISTS `jupgrade_default_categories`;
CREATE TABLE IF NOT EXISTS `jupgrade_default_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
